  ...
  return (
    <>
      <div className="flex flex-col w-[550px]">
        <h2 className="text-black-color-one text-3xl font-bold mb-6">
          {t2("arabicModal-title")}
        </h2>
        ...
        <ol
          type="1"
          style={{ listStylePosition: "inside", listStyle: "auto" }}
          className="p-4 text-black-color-two text-md font-normal flex flex-col gap-3"
        >
          <li>{t2("arabicModal-list.0")}</li>
          <li>{t2("arabicModal-list.1")}</li>
          <li>{t2("arabicModal-list.2")}</li>
        </ol>
      </div>
      <div className="flex flex-col gap-5">
        <h6 className="font-semibold text-black-color-one text-lg">
          {t("title")}
        </h6>
