...
function BannerComponent() {
  ...
  return (
    <div className='flex justify-center items-center '>
        <Banner className='ml-5  animate-bounce hover:animate-none transition-all duration-300'>
       <div className="flex ml-5 w-[calc(100%-2rem)] mb-5 flex-col justify-between rounded-lg border border-gray-100 bg-white p-4 shadow-sm dark:border-gray-600 dark:bg-gray-700 md:flex-row lg:max-w-7xl">
