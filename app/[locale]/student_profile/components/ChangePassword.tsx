...
function ChangePassword({ onCancel }: ChangePasswordProps) {
    ...
    const handlePasswordUpdate = async (e: any) => {
      ...
      alert('sf')
          ...
          .then((data) => {
          if(data.success){
            showToast('success', 'Password Update Successful', 'Password has been updated successfully.');
          }
          else{
  ...
  return (
    ...
    <form onSubmit={handlePasswordUpdate}>
     ...
     <input
            ...
            className="rounded-2xl shadow-sm placeholder-black  border border-[#828282] pl-5 text-gray-900 text-sm   focus:border-[--secondary-color] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
            <span
      ...
      <div className="relative z-0  mb-6 group">
         <input
            ...
            placeholder='Enter new Password'
             className="rounded-2xl shadow-sm grow w-[240px] placeholder-black  border border-[#828282] pl-5 text-gray-900 text-sm   focus:border-[--secondary-color] block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" 
             required />
              <span
            className="absolute top-3 right-3 cursor-pointer"
        ...
        className="rounded-2xl shadow-sm grow placeholder-black w-[240px]	 border border-[#828282] pl-5 text-gray-900 text-sm   focus:border-[--secondary-color] block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" 
        required />
         <span
            className="absolute top-3 right-3 cursor-pointer"
