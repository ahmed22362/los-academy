          ...
          <div className='p-10 pt-3'>
            ...
            <div className="content mt-5">
                    ...
                    <h3 className='pl-2 text-md font-medium'>Plan Details</h3>
                        <div>
                        <p className='bg-green-500 text-white px-3 text-center py-1 rounded-lg'>{mySubscription?.planTitle ||'No Plan'}</p>
                ...
                <div className="flex justify-between mt-10">
                    <div>
                    <h3 className='font-medium text-lg mb-3'>Subscription Date</h3>
                      <p>
                      {convertDateTimeZone(mySubscription?.subscriptionStartAt, "UTC", Intl.DateTimeFormat().resolvedOptions().timeZone, "MMM D,YYYY")}
                        </p>          
                    </div>
                    <div>
                    <h3 className='font-medium text-lg mb-3'>Renewal Date</h3>
                      <p>
                      {convertDateTimeZone(mySubscription?.subscriptionEndAt
, "UTC", Intl.DateTimeFormat().resolvedOptions().timeZone, "MMM D,YYYY")}
                        </p>          
                    </div>
                </div>
