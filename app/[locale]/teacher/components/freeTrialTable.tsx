    ...
    <div className={"w-full my-5"}>
      ...
      <div className={"adminBox mt-4 flex flex-col w-full mx-auto"}>
        {loading ? (
          ...
          totalFree.map((freeSession: any, index: number) => {
            return (
              <div
                key={index}
                className={
              ...
              >
                <details>
                  ...
                  <div className="flex justify-center items-center gap-3">
                    <ul className="ps-4">
                      <li>
                        <span>Student Name: {freeSession.user?.name}</span>
                      </li>
                      <li>
                        <span>
                          start time:{" "}
                      ...
                      <li>
                        <span>type: {freeSession.type}</span>
                      </li>
                      sessions dates:
                      {freeSession.sessionDates.map(
                ...
                <h5
                  onClick={() => handleAssignSession(freeSession)}
                  className={
