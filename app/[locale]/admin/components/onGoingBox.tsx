...
export default function OnGoingBox() {
  ...
  return (
    <div
      className={
        "flex-col justify-center items-center gap-[16px] h-[240px] w-full text-center adminBox"
      }
    >
      ...
      <div className={"bg-white-color p-5 rounded-[16px]"}>
        {isLoading ? (
          ...
          <div
            className={
              "flex flex-col items-center text-md font-semibold text-[black-color-one]"
            }
          >
            <span>
              {convertTime(
                allSessions[0].sessionDate,
                "UTC",
