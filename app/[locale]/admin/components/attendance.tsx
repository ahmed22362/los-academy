...
export default function Attendance() {
    return(
        <div className={"flex flex-row justify-center items-center flex-wrap gap-[10px] h-[240px] max-md:h-auto text-center max-md:w-full shadow-[0_4px_14px_0_rgba(0,0,0,0.25)] rounded-[24px] p-[15px]"}>
