      ...
      <div className={"px-5 py-4"}>
        <Table>
          <Table.Head theme={customTheme.head}>
            ...
            <Table.HeadCell theme={customTheme.head}>Role</Table.HeadCell>
          ...
          <Table.Body className="divide-y">
            {isLoading ? (
              ...
              displaydTeachers.map((teacher: any, index: number) => {
                return (
                  <FetchTeacherData
                    key={index}
                    teacherData={teacher}
                    updateComponent={fetchAllTechers}
                  />
                );
              })
            ) : (
              <tr>
                <td className="p-5">There is No Teachers</td>
              </tr>
            )}
          </Table.Body>
        </Table>
