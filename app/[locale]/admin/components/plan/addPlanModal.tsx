        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <TextInput
              ...
              onChange={(e: any) => setPlanPrice(parseInt(e.target.value, 10))}
              type="number"
            />
            <span className="text-red-500 text-[13.5px] ml-2">
              If the price is not provided, it will be calculated based on the
              minute cost.
            </span>
          </div>
          <div>
