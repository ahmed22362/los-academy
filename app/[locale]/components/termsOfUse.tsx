...
import Image from "next/image";
  ...
  export default function TermsOfUse({
    ...
    return (
      <>
        <Modal
          show={openTermsofServicesModal}
          className="block space-y-0 md:flex md:space-y-0 md:space-x-4 "
          size={"xl"}
          onClose={() => setOpenTermsofServicesModal(false)}
        >
          <Modal.Header className="p-3 flex justify-center items-center ">
            <div className="ml-7 flex justify-center items-center gap-1 text-center ms-auto">
             <Image src={'/vectors/terms-of-use.png'} alt="terms of use" width={20} height={100}/>
             <h3 className="text-center font-bold">Terms Of Use</h3>
