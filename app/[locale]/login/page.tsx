    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col gap-4" style={{width:'100%'}}>
          <input className="border-blue-600 gradiant-color	 rounded-3xl w-full		border-2	" type="email" placeholder="Email address " />
          <input className="border-blue-600 gradiant-color	 rounded-3xl w-full		border-2	" type="password" placeholder="Password" />
          <Link className="font-semibold	 underline" href={'#'}>Forget Password ?</Link>
          <PrimaryButton text="Login" ourStyle="bg-secondary-color text-white	py-3 border rounded-3xl text-xl	 w-full" />
          <span className="text-center">Or Login with </span>
        <div className="flex gap-3">
        <PrimaryButton text="Google" ourStyle="border-blue-700 rounded-3xl w-full	py-2	border-2 hover:bg-blue-700 hover:text-white transition-all	duration-500	" />
          <PrimaryButton text="Facebook" ourStyle="border-blue-700 rounded-3xl w-full	py-2	border-2 hover:bg-blue-700 hover:text-white transition-all	duration-500	" />
        </div>
        </div>
          </div>
        </Tabs.Item>
        <Tabs.Item title="Signup" onClick={()=>setActiveTab(false)}>
        <div className=" flex justify-center items-center gap-3 flex-col flex-wrap " style={{minHeight:'300px' ,width:'100%'}}>
        <Toast>
