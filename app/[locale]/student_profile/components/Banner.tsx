...
function BannerComponent({message ,animation ,header ,fromTeacherRequest}:any) {
    const [openPlansModal, setOpenPlansModal] = useState<boolean>(false)
  return (
    <div className='flex justify-center items-center '>
        <Banner className={`ml-5  ${animation} hover:animate-none transition-all duration-300`}>
       <div className="flex  ml-5 w-[calc(100%-2rem)] mb-5  justify-between rounded-lg border border-gray-100 bg-white p-4 shadow-sm dark:border-gray-600 dark:bg-gray-700 md:flex-row lg:max-w-7xl">
         <div className={`mb-3 mr-4 flex md:gap-3 ${fromTeacherRequest?"md:flex-col":""} items-start md:mb-0  md:items-center`}>
           <div
