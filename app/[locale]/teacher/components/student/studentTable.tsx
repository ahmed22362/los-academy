      ...
      <div className={"px-5 py-4"}>
        <Table>
          <Table.Head theme={customTheme.head}>
            ...
            <Table.HeadCell theme={customTheme.head}>Name</Table.HeadCell>
            <Table.HeadCell theme={customTheme.head}>Gender</Table.HeadCell>
          ...
          <Table.Body className="divide-y">
            {isLoading ? (
              ...
              displaydStudents.map((student: any, index: number) => {
                return (
                  <FetchStudentData
                    key={index}
                    studentData={student}
              ...
              <tr>
                <td className="p-5">There is No Students</td>
              </tr>
            )}
          </Table.Body>
        </Table>
