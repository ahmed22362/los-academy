  ...
  return (
    <div>
      <div className={`flex justify-center gap-3 items-center mt-10 overflow-hidden`}>
        <div
          className="bg-secondary-color max-sm:px-2  sm:px-4 w-fit text-center md:px-2 max-[400px]:px-1 max-[400px]:py-4   text-sm font-semibold transition-colors text-white shadow-[0px_4px_10px_0px_rgba(0,0,0,0.25)] py-3 lg:px-10  rounded-3xl  mx-auto "
        ...
        <div
          className="bg-secondary-color sm:px-4 max-sm:px-2 w-fit text-center md:px-2  text-sm max-[400px]:px-1 max-[400px]:py-4 font-semibold transition-colors text-white shadow-[0px_4px_10px_0px_rgba(0,0,0,0.25)] py-3 lg:px-10  rounded-3xl  mx-auto "
        >
