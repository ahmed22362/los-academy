    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-[450px]">
        ...
        <div className="flex flex-col gap-1 justify-center items-center w-full">
          ...
          />
            {errors.name && touched.name ? 
                <span className="text-danger-color capitalize">{errors.name}</span> 
              : ""}
        </div>
        <div className="flex flex-col gap-1 justify-center items-center w-full">
          <input
      ...
      <div className="flex flex-col gap-1 justify-center items-center">
        ...
        />
          {errors.phone && touched.phone ? 
              <span className="text-danger-color capitalize">{errors.phone}</span> 
            : ""}
      </div>
      <div className="flex flex-col gap-1 justify-center items-center">
        <input
          ...
          onChange={handleChange}
          onBlur={handleBlur}
          className={`${errors.email && touched.email ? "border-[--danger-color]" : "border-[--secondary-color]"} gradiant-color rounded-3xl w-full border-2`}
          type="email"
          placeholder="Email address"
        />
          {errors.email && touched.email ? 
              <span className="text-danger-color capitalize">{errors.email}</span> 
            : ""}
      </div>
      <div className="flex flex-col gap-1 justify-center items-center">
        <input
          ...
          onChange={handleChange}
          onBlur={handleBlur}
          className={`${errors.password && touched.password ? "border-[--danger-color]" : "border-[--secondary-color]"} gradiant-color rounded-3xl w-full border-2`}
          type="password"
          placeholder="Password"
        />
          {errors.password && touched.password ? 
              <span className="text-danger-color capitalize">{errors.password}</span> 
            : ""}
      </div>
      <div className="flex flex-col gap-1 justify-center items-center">
        <input
          ...
          onChange={handleChange}
          onBlur={handleBlur}
          className={`${errors.passwordConfirmation && touched.passwordConfirmation ? "border-[--danger-color]" : "border-[--secondary-color]"} gradiant-color rounded-3xl w-full border-2`}
          type="password"
          placeholder="Confirm Password"
        />
          {errors.passwordConfirmation && touched.passwordConfirmation ? 
            <span className="text-danger-color capitalize">{errors.passwordConfirmation}</span> 
          : ""}
      ...
      <div className="flex justify-between items-center  px-10 flex-wrap gap-9 py-3">
        ...
        {errors.gender && touched.gender ? (
            <span className="text-danger-color text-center">{errors.gender}</span>
          ) : (
            ""
            )}
      </div>
