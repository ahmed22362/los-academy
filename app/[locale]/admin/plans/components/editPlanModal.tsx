...
export default function EditPlanModal({
  ...
  const updateStudent = () => {
    ...
    if (
      sessionsPerWeek !== planDetails.sessionsPerWeek &&
      sessionsPerWeek !== 0
    ) {
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <TextInput
                min={0}
                id="sessionDuration"
                defaultValue={planData.sessionDuration}
                onChange={(e: any) =>
            ...
            <div>
              ...
              <TextInput
                min={0}
                id="sessionsCount"
                defaultValue={planData.sessionsCount}
                onChange={(e: any) =>
                  setSessionsCount(parseInt(e.target.value, 10))
                }
                type="number"
              />
            </div>
            <div>
              ...
              <TextInput
                min={0}
                id="sessionsPerWeek"
                defaultValue={planData.sessionsPerWeek}
                onChange={(e: any) =>
                  setSessionsPerWeek(parseInt(e.target.value, 10))
                }
                type="number"
              />
            </div>
            <div>
              ...
              <TextInput
                ...
                onChange={(e: any) => setPrice(parseInt(e.target.value, 10))}
                type="number"
              />
            </div>
            <div>
              ...
              <TextInput
                min={0}
                id="discount"
                defaultValue={planData.discount}
                onChange={(e: any) => setDiscount(parseInt(e.target.value, 10))}
                type="number"
              />
            </div>
            <div>
              ...
              <Select
                id="recommended"
                onChange={(e: any) => setRecommended(e.target.value === "true")}
                defaultValue={planData.recommended}
              >
