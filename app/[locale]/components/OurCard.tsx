...
function OurCard({ data }: { data: any }) {
  ...
  const customTheme: CustomFlowbiteTheme = {
    card: {
      root: {
        children:
          "flex h-[100%] flex-col items-center justify-center text-center gap-0 p-6 max-sm:p-1",
      },
    },
  };
  ...
  return (
    <Card theme={customTheme.card} className="max-w-sm">
      ...
      <div className="rounded-full w-fit bg-white-color m-auto flex justify-center items-center py-7 px-5">
        <Image
