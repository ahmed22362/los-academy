...
function ForgetPassword({openForgetPassword ,setOpenForgetPasswordModal }:any) {
  ...
  return (
    <div>
      <Modal   show={openForgetPassword} className='block space-y-0 md:flex md:space-y-0 md:space-x-4 ' size={'xl'}  onClose={() => setOpenForgetPasswordModal(false)}>
      <Modal.Header className=' border-0'><div className='flex justify-center items-center'>Forget Password</div></Modal.Header>

        <Modal.Body >
        <Toast ref={toast}  />
          <div className='forgetPassword flex gap-5 items-center py-12   justify-center'>
                <label htmlFor="forgetMail" className='text-xl'>Email:</label>
                <input
