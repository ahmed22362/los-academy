        ...
        upComingSession?.map((session, index) => (
          <div key={index}>
            ...
            <div className={`flex gap-4 mb-3 mt-7`}>
              ...
              />
              <PrimaryButton
                ourStyle="hover:bg-secondary-hover max-md-px-1 text-sm font-semibold transition-colors shadow-[0px_4px_10px_0px_rgba(0,0,0,0.25)] h-10 px-3 w-full shadow rounded-full w-50 mx-auto max-md:px-4 max-md:w-45"
