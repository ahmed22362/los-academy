        ...
        <Modal.Body>
          <div className="space-y-6">
            ...
            <div>
              <div className="mb-2 block">
                <Label
                  htmlFor="availableFreeSession"
                  value="Available Free Session"
                />
              </div>
              <TextInput
                id="availableFreeSession"
                type="text"
                defaultValue={studentDetails.availableFreeSession}
                onChange={(e) => setAvailableFreeSession(e.target.value)}
              />
            </div>
            <div>
              <div className="mb-2 block">
            ...
            <div>
              ...
              <TextInput
                id="remainSessions"
                type="text"
                defaultValue={studentDetails.remainSessions}
                onChange={(e) => setRemainSessions(e.target.value)}
              />
            </div>
            <div>
              <div className="mb-2 block">
