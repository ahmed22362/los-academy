...
function BannerComponent({
  ...
  return (
    <div className="flex  justify-center items-center ">
      ...
      >
        <div className="flex sm:flex-col lg:flex-row   max-[450px]:flex-col  ml-5 w-[calc(100%-2rem)] mb-5  justify-between rounded-lg border border-gray-100 bg-white p-4 shadow-sm dark:border-gray-600 dark:bg-gray-700 md:flex-row lg:max-w-7xl">
          <div
            className={`mb-3 mr-4 sm:flex-col lg:flex-row max-[450px]:flex-col flex md:gap-3 ${
          ...
          {fromTeacherRequest ? (
            ...
            <div className="flex flex-shrink-0 items-center">
              <button
                ...
                className="text-white px-3 sm:px-2 lg:px-3 lg:py-3 lg:text-md max-[450px]:px-2 sm:py-2 max-[450px]:py-2 sm:text-sm max-[450px]:text-sm py-3 rounded-xl bg-[--secondary-color] hover:bg-[#3f3aa6]"
              >
                Subscribe Now
              </button>
